...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 relative">
      {/* Hero Section */}
      <section className="relative py-26 px-6 overflow-hidden h-screen">
        {/* Background Image */}
        <Image
          src="/sekolah.webp" // Ganti sesuai nama file kamu
          alt="Background Hero"
          fill
        ...
        {/* Konten Hero */}
        <div className="max-w-6xl mx-auto text-center space-y-8 relative mt-37 z-20">
