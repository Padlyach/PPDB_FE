          ...
          <div className="mb-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 mb-4 border-l-4 border-blue-500">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-[#00215E]">BJB</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-gray-700">Nomor Rekening:</span>
                  <span className="font-bold text-[#00215E] text-lg tracking-wider">0130010023323</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-gray-700">Atas Nama:</span>
                  <span className="font-bold text-[#00215E]">Pesat Birrulwalidain YYS</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-6 border-l-4 border-orange-500">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-gray-700">Bank:</span>
                  <span className="font-bold text-[#00215E]">BTN</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-gray-700">Nomor Rekening:</span>
                  <span className="font-bold text-[#00215E] text-lg tracking-wider">00227.01.30.000118.4</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold text-gray-700">Atas Nama:</span>
                  <span className="font-bold text-[#00215E]">Pesat Birrulwalidain YYS</span>
          ...
          <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-6">
            ...
            <div className="text-center">
              <a 
                ...
                className="inline-flex items-center bg-white text-green-600 font-bold py-4 px-8 rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
