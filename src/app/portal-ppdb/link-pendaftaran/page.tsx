...
export default function LinkPendaftaran() {
  ...
  <div className="md:w-1/2">
    <p className="text-lg text-gray-700 leading-relaxed mb-6">
      Pendaftaran peserta didik baru untuk <strong>SMP, SMA, dan SMK Pesat</strong> telah dibuka!
Kami mengundang orang tua dan calon siswa untuk bergabung dalam lingkungan pendidikan yang unggul, Islami, dan responsif terhadap perkembangan zaman.
Dengan kurikulum inovatif, tenaga pendidik profesional, dan fasilitas modern, Pesat School berkomitmen mencetak generasi berkarakter, berwawasan global, serta unggul secara akademik dan non-akademik.
    </p>
    <p className="text-lg text-gray-700 leading-relaxed">
      Segera daftarkan diri Anda dan raih masa depan cerah bersama Pesat School. Jadilah bagian dari generasi cerdas, mandiri, dan berdaya saing tinggi!
    </p>
  </div>
  <div className="md:w-1/2">
