      ...
      <div className="max-w-7xl mx-auto px-8 py-6 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-5 font-extrabold text-lg relative">
          <li className="relative mt-2">
            <Link
              href="/"
              className="relative my-2 text-[#00215E] hover:text-[#FAA300] transition-colors duration-300 after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-[#FFD700] after:left-0 after:bottom-0 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
            >
              BERANDA
            </Link>
          </li>
          ...
          <li className="relative">
            <button
              ...
              className="relative py-2 text-[#00215E] hover:text-[#FAA300] transition-colors duration-300 after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-[#FFD700] after:left-0 after:bottom-0 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
            >
              PORTAL PPDB
            </button>
            {isPortalOpen && (
              <ul className="absolute bg-white shadow-xl mt-2 rounded-lg overflow-hidden z-50 text-sm text-left">
                <li>
                  <Link href="/portal-ppdb/link-pendaftaran" className="block px-4 py-2 hover:bg-[#FAA300]/10 text-[#00215E] hover:text-[#FAA300]">
                    Link Pendaftaran
                  </Link>
                </li>
                <li>
                  <button
                    ...
                    className="w-full text-left px-4 py-2 hover:bg-[#FAA300]/10 text-[#00215E] hover:text-[#FAA300]"
                  >
                    Website ▼
                  </button>
                  {isWebsiteOpen && (
                ...
                <li>
                  <Link href="/portal-ppdb/dana-investasi" className="block px-4 py-2 hover:bg-[#FAA300]/10 text-[#00215E] hover:text-[#FAA300]">
                    Dana Investasi
                  </Link>
                </li>
                <li>
                  <Link href="/portal-ppdb/informasi-rekening" className="block px-4 py-2 hover:bg-[#FAA300]/10 text-[#00215E] hover:text-[#FAA300]">
                    Informasi Rekening
                  </Link>
                </li>
              </ul>
